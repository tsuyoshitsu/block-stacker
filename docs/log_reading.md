...
2026-... [training.train] 長期記憶を保存: output\mvp2\replay_buffer.pkl
2026-... [training.train] Resume state saved: output\mvp2\resume_state.json (next_stage=2, completed=[1])
```
...
2026-... [serving.ai] loading model: output\mvp2\fresh\sac_20260627-143022_4000_steps.zip   ← 無指定なら find_latest_checkpoint で最新 run の最大ステップを自動選択
